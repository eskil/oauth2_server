defmodule Mix.Tasks.Oauth2Server.Init do
  ...
  def create_oauth_tables() do
    ...
    create_oauth_clients_query = "CREATE TABLE IF NOT EXISTS oauth_clients (id bigint(20) unsigned NOT NULL AUTO_INCREMENT, random_id varchar(255) NOT NULL, secret varchar(255) NOT NULL, allowed_grant_types varchar(2020) NOT NULL, inserted_at datetime, updated_at datetime, redirect_url varchar(255), PRIMARY KEY (id))"
